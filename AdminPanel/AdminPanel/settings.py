...
INSTALLED_APPS = [
    ...
    'DataTableApp.apps.DatatableappConfig',
    'bootstrap5',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'DataTableApp', 'templates', 'DataTableApp')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'
STATIC_ROOT = os.path.join(BASE_DIR, 'DataTableApp/static/DataTableApp')
